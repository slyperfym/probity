    ...
    <main className="min-h-screen bg-slate-950">
      <section className="probity-grid border-b border-white/10">
        <div className="mx-auto w-full max-w-7xl px-4 py-7 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
          <Badge className="border-cyan-300/25 bg-cyan-400/[0.07] text-cyan-100/90 shadow-none" variant="info">
            Market Board
          </Badge>
          <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex w-fit items-center gap-2 rounded-md border border-cyan-400/15 bg-cyan-400/[0.06] px-3 py-2 text-xs font-medium text-cyan-100/85">
